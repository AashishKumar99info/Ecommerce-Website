...
const ProfilePage = () => {
    ...
    const updateUserPassword = async (e) => {
        e.preventDefault();
        const response = await fetch(`https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyAtOlLvw9t2Fc8_n8Y6i5AwmNTKFYRapRk`, {
            method: 'POST',
            headers: {
        ...
        <Container>
            <Row className="mt-4">
                <Col md={4}>
                    ...
                    <h4 style={{ color: 'white' }} className="mt-2">Username</h4>
                ...
                <Col md={8}>
                    ...
                    <h4 style={{ color: 'white' }} className="mt-4">Favorites</h4>
                    {/* display favorites */}
                </Col>
            </Row>
        </Container>

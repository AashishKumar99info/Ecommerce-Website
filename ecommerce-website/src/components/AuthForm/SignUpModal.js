...
const SignUpModal = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    let URL = "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAtOlLvw9t2Fc8_n8Y6i5AwmNTKFYRapRk";
    if (isSignIn) {
      URL = 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAtOlLvw9t2Fc8_n8Y6i5AwmNTKFYRapRk'
    }
